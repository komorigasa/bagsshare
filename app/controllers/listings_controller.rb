class ListingsController < ApplicationController
  ...
  private
  def listing_params
    params.require(:listing).permit(:travel_type, :travel_country, :departure_port, :arrival_port, :commodity_prices, :price, :address, :listing_title, :listing_content, :active)
  end
